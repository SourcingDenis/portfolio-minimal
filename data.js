const main = {
  ...
  img: 'https://github.com/SourcingDenis/portfolio-minimal/blob/master/README_DOCS/ddd.jpg',
  ...
  links: [
    { name: 'OSINT 🔎 Stash', link: 'http://osint.best/' },
    { name: 'Blog on Hiring', link: 'https://medium.com/@SourcingDenis/' }
  ]
};
